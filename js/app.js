...
(function(){
  ...
  const I18N = {
    ru: {
      ...
      /* WHY */
      why_title:'Почему я',
      why1_t:'Забота и безопасность',         why1_d:'Учитываю аллергии и особенности ребёнка, заранее согласовываю действия на случай ЧП. Есть сертификаты CPR / First Aid.',
      ...
      why4_t:'Соблюдаю режим семьи',          why4_d:'Придерживаюсь привычного распорядка ребёнка и договорённостей по питанию, прогулкам, занятиям и ограничениям.',
    ...
    sr: {
      ...
      /* WHY */
      why_title:'Zašto ja',
      why1_t:'Briga i bezbednost',          why1_d:'Vodim računa o alergijama i osobenostima deteta; unapred dogovaramo postupanje u hitnim situacijama. Imam CPR / First Aid sertifikate.',
      ...
      why4_t:'Poštujem porodični ritam',     why4_d:'Pratim uobičajeni raspored deteta i dogovore o ishrani, šetnjama, aktivnostima i ograničenjima.',
