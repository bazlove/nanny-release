...
(function(){
  ...
  const I18N = {
    ru: {
      ...
      regular_modal_title:'Регулярный график',
      ...
      regular_schedule_err:'Укажите желаемые дни и часы',
    ...
    sr: {
      ...
      regular_modal_title:'Redovan raspored',
      ...
      regular_schedule_err:'Navedite željene dane i vreme',
